package br.com.escovandobit.microservicos.fornecedor.config;

import br.com.escovandobit.microservicos.fornecedor.exception.BusinessException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleBusinessException(BusinessException ex, WebRequest request) {
        return handleError(ex, ex.getClass().getAnnotation(ResponseStatus.class).code());
    }
